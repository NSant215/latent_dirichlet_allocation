...
def mlm(A, V):
    """
    A: matrix of shape (N, 3) where N is the number of words in the document.
    A[:, 0] is the document number, A[:, 1] is the word number, A[:, 2] is the number of occurrences of the word in the document.
    V: array of shape (W,) containing the unique words
